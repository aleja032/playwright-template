...
2. **`.opencode/rules/escenarios-output.md`** — contiene las instrucciones exactas de formato
...
6. Genera el archivo `escenarios.md` aplicando exactamente lo definido
   en `.opencode/rules/escenarios-output.md`.
...
El agente debe:
1. Leer `specs/[feature].md`
2. Leer `.opencode/rules/escenarios-output.md`
